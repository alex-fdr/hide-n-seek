...
class OutlineEffect {
    ...
    constructor(renderer, parameters = {}) {
        ...
        const defaultAlpha =
            parameters.defaultAlpha !== undefined
        ...
        function restoreOriginalMaterial(object) {
            ...
            if (Array.isArray(object.material)) {
                for (let i = 0, il = object.material.length; i < il; i++) {
                    object.material[i] =
                        originalMaterials[object.material[i].uuid];
                }
            } else {
        ...
        function updateUniforms(material, originalMaterial) {
            const outlineParameters =
                originalMaterial.userData.outlineParameters;
            ...
            if (outlineParameters !== undefined) {
                ...
                if (outlineParameters.alpha !== undefined)
                    material.uniforms.outlineAlpha.value =
        ...
        this.renderOutline = function (scene, camera) {
            ...
            outlinedObjects.forEach((t) => t.traverse(setOutlineMaterial));

            renderer.render(scene, camera);

            outlinedObjects.forEach((t) => t.traverse(restoreOriginalMaterial));
        ...
        this.setOutlinedObjects = function (objects = []) {
            outlinedObjects.push(...objects);
        };
    }
}
